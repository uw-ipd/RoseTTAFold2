...
class RoseTTAFoldModule(nn.Module):
    ...
    def forward(self, msa_latent=None, msa_full=None, seq=None, xyz=None, idx=None,
                ...
                use_checkpoint=False, p2p_crop=-1, topk_crop=-1, cyclize_reses=None, 
        ...
        msa_latent, pair, state = self.latent_emb(msa_latent, seq, idx, stride=msa_stripe, cyclize_reses=cyclize_reses)
